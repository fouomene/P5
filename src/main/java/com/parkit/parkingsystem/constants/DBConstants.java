...
public class DBConstants {
    ...
    public static final String GET_IMMAT_FROM_TICKETS = "select t.VEHICLE_REG_NUMBER, t.ID from ticket t where t.VEHICLE_REG_NUMBER=? order by t.VEHICLE_REG_NUMBER";
